...
message_receive1 = "[CQ:image,file=99AD14A7FFD13BAEA8C6AAAF19037156.jpg,url=(https://c2cpicdw.qpic.cn/offpic_new/1938466844//1938466844-3991116225-99AD14A7FFD13BAEA8C6AAAF19037156/0?term=2)]"
message_receive2 = ''
...
m_emotion = re.match(r'(.*)(\[CQ\:face\,id\=\d+\])(.*)', message_receive1)
m_image = re.match(r'\[CQ\:image.*url\=\((http.+)\)\]', message_receive2)
