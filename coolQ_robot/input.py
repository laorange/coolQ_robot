...
def input_inform_once(qq, message, send_time, code='m_day_one_time'):
    ...
    with open('user_data/everyday_infos/time2verify_one_time.csv', 'at') as time2verify_one_time_csv:
        time2verify_one_time_csv.write(code + ',' + str(int(qq)) + ',' + message + ',' + send_time + '\n')
...
def input_today_once_inform(qq, message, send_time, code='today_one_time'):
    ...
    with open('user_data/everyday_infos/time2verify_one_time.csv', 'at') as time2verify_one_time_csv:
        time2verify_one_time_csv.write(code + ',' + str(int(qq)) + ',' + message + ',' + t_Ymd + send_time + '\n')
